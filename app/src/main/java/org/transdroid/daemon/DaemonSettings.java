...
import org.transdroid.core.app.settings.MutualSslHelper;
...
public final class DaemonSettings {
	...
	final private MutualSslHelper handshakeCertificates;
	...
	protected DaemonSettings() {
		this(null, null, null, 0, false, false, null, null, null, false, null, null, null,
	...
	public DaemonSettings(String name, Daemon type, String address, int port, boolean ssl,
						  boolean sslTrustAll, String sslTrustKey, MutualSslHelper handshakeCertificates, String folder, boolean useAuthentication,
	...
	public MutualSslHelper mutualSslHelper() {
