...
public class ServerSetting implements SimpleListItem {
	...
	private final MutualSslHelper handshakeCertificates;
	...
	public ServerSetting(int key, String name, Daemon type, String address, String localAddress, int localPort, String localNetwork, int port,
						 boolean ssl, boolean localSsl, boolean sslTrustAll, String sslTrustKey, MutualSslHelper handshakeCertificates, String folder, boolean useAuthentication, String username,
	...
	public MutualSslHelper getHandshakeCertificates() {
	...
	private DaemonSettings convertToDaemonSettings(String connectedToNetwork, Context caller) {
		...
		return new DaemonSettings(name, type, addressToUse, portToUse, sslEnable, sslTrustAll, sslTrustKey, handshakeCertificates, folder,
